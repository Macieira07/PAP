    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function getResponse(message) {
            ...
            if (containsAny(lowercaseMessage, ['acomodação', 'acomodacoes', 'quarto', 'quartos', 'casa', 'apartamento', 'estúdio', 'suite', 'dormir', 'hospedagem'])) {
                ...
                } else if (containsAny(lowercaseMessage, ['casa da fonte', 'fonte'])) {
                    return responses.acomodacoes.casafonte;
                } else if (containsAny(lowercaseMessage, ['estúdio', 'estudio', 'jardim'])) {
                    return responses.acomodacoes.estudiojardim;
                } else if (containsAny(lowercaseMessage, ['suite', 'romântica', 'romantica', 'jacuzzi'])) {
                    return responses.acomodacoes.suiteromantica;
                } else {
