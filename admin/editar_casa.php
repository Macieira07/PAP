...
if (isset($_GET['modal'])) {
    ...
    ?>
    <form method="post">
        Nome: <input type="text" name="nome" value="<?= htmlspecialchars($casa['C_nome']) ?>" required><br><br>
        Descrição: <textarea name="descricao"><?= htmlspecialchars($casa['C_descricao']) ?></textarea><br><br>
        ...
        Características: <textarea name="caracteristicas"><?= htmlspecialchars($casa['C_caracteristicas']) ?></textarea><br><br>
        Estado:
        <select name="estado">
