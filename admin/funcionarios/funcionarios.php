  ...
  <head>
      ...
      <style>
          ...
          .centered-header-filtros {
              display: flex;
              flex-direction: column;
              align-items: center;
              margin-bottom: 20px;
          }
          .centered-header-filtros h1 {
              margin: 0 0 10px 0;
          }
          .centered-header-filtros form {
              display: flex;
              gap: 10px;
              align-items: center;
              justify-content: center;
          }
          .centered-header-filtros input[type="text"] {
              padding: 6px 10px;
              border-radius: 4px;
              border: 1px solid #ccc;
          }
          .centered-header-filtros button {
              padding: 6px 16px;
              border-radius: 4px;
              border: none;
              background: #4CAF50;
          ...
          .centered-header-filtros button i {
              margin-right: 4px;
          }
      </style>
  </head>
  ...
  <div class="centered-header-filtros">
      ...
      <a href="#" id="btnAdicionarFuncionario" class="btn-adicionar" style="margin-top:10px;"><i class="fa-solid fa-user-plus"></i> Adicionar Funcionário</a>
  </div>
      ...
      <tr>
          ...
          <td>
              ...
              <?php if ($turno): ?>
                  ...
                  <br><button class="btn btn-view btn-small btnEditarTurno" data-id="<?= $turno['T_id_turno'] ?>"><i class="fa-solid fa-pen-to-square"></i> Editar Turno</button>
              <?php else: ?>
                  <span class="badge badge-error">Nenhum turno registrado</span>
              <?php endif; ?>
          </td>
          <td class="acao">
              <button class="btn btn-view btn-small btnEditarFuncionario" data-id="<?= $f['F_id_funcionario'] ?>"><i class="fa-solid fa-pen-to-square"></i></button>
              <a href="eliminar_funcionario.php?id=<?= $f['F_id_funcionario'] ?>" class="btn button-danger btn-small" onclick="return confirm('Tem a certeza que quer eliminar?')"><i class="fa-solid fa-trash"></i></a>
          </td>
      </tr>
      <?php endwhile; ?>
      </tbody>
