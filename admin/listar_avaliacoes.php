...
<div class="container">
    ...
    <div class="tab-container">
        ...
        <div id="analise" class="tab-content active">
            ...
            <div class="chart-container">
                <h2 class="chart-title">Satisfação Geral</h2>
                <div class="satisfaction-grid">
                    <div>
                        <h3>Recepção</h3>
                        <canvas id="graficoRecepcao" height="200"></canvas>
                    </div>
                    <div>
                        <h3>Expectativas</h3>
                        <canvas id="graficoExpectativas" height="200"></canvas>
                    </div>
                    <div>
                        <h3>Recomendação</h3>
                        <canvas id="graficoRecomendacao" height="200"></canvas>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="filter-row">
                    ...
                    <div class="filter-group">
                        ...
                        <select id="filtro-recomendacao">
                            ...
                            <option value="Sim">Recomendariam</option>
                            <option value="Não">Não recomendariam</option>
                        </select>
                    </div>
                    
                    <button class="btn-filter" onclick="filtrarTabela()">Filtrar</button>
                </div>
            </div>
