...
<head>
    ...
    <title>Reservas - Painel da Quinta Flores</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="admin_reservas.php" class="active"><span class="icon">📅</span> Reservas</a></li>
    ...
    <div class="main">
        ...
        <a href="nova_reserva.php" class="add-btn">
            <span>+</span> Adicionar Nova Reserva
        </a>
            ...
            <tbody>
                <?php if ($resultado && $resultado->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $reserva['H_nome'] ?></td>
                        <td><?= $reserva['R_id_casa'] ?></td>
                        <td><?= $reserva['R_data_checkin'] ?></td>
                        <td><?= $reserva['R_data_checkout'] ?></td>
                        <td>
                            <span class="status-badge <?= strtolower($reserva['R_estado']) ?>">
                                <?= $reserva['R_estado'] ?>
                            </span>
                        </td>
                        <td>
                            <a href="editar_reserva.php?id=<?= $reserva['R_id_reserva'] ?>" class="action-btn edit-btn">Editar</a>
                            <a href="excluir_reserva.php?id=<?= $reserva['R_id_reserva'] ?>" class="action-btn delete-btn" onclick="return confirm('Tem certeza que deseja excluir esta reserva?')">Excluir</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
