...
/*
 * ============================================================
 *   Lógica de Login (Processamento) - Quinta Flores
 * ============================================================
 *
 *   Linguagens Utilizadas:
 *     - PHP (backend, autenticação)
 *     - JSON (resposta para AJAX)
 *
 *   Bibliotecas e Frameworks:
 *     - PHPMailer (envio de emails, se necessário)
 *     - MySQLi/PDO (acesso à base de dados)
 *
 *   Estrutura da Página:
 *     1. Configuração inicial PHP (includes, sessão)
 *     2. Receção e validação dos dados do formulário
 *     3. Consulta à base de dados
 *     4. Verificação de senha
 *     5. Resposta (redirecionamento ou erro)
 *
